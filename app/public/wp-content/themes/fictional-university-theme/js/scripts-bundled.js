...
var _Notes = _interopRequireDefault(__webpack_require__(7));
...
var notes = new _Notes.default();
var notes = new _Like.default();
  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      _jquery.default.getJSON(universityData.root_url + '/wp-json/university/v1/search?term=' + this.searchField.val(), function (results) {
        _this.resultsDiv.html("\n        <div class=\"row\">\n          <div class=\"one-third\">\n\n            <h2 class=\"search-overlay__section-title\">General Information</h2>\n            ".concat(results.generalInfo.length ? '<ul class="link-list min-list">' : '<p>No results found</p>', "\n              ").concat(results.generalInfo.map(function (item) {
          return "<li><a href=\"".concat(item.permalink, "\">").concat(item.title, "</a>").concat(item.postType == 'post' ? "<span> by ".concat(item.authorName, ".</span>") : '', "</li>");
        }).join(''), "\n            ").concat(results.generalInfo.length ? '</ul>' : '', "\n          </div>\n\n          <div class=\"one-third\">\n            <h2 class=\"search-overlay__section-title\">Programs</h2>\n            ").concat(results.programs.length ? '<ul class="link-list min-list">' : "<p>No programs found. <a href=\"".concat(universityData.root_url, "/programs\">View all programs</a></p>"), "\n              ").concat(results.programs.map(function (item) {
          return "<li><a href=\"".concat(item.permalink, "\">").concat(item.title, "</a></li>");
        }).join(''), "\n            ").concat(results.programs.length ? '</ul>' : '', "\n\n            <h2 class=\"search-overlay__section-title\">Professors</h2>\n            ").concat(results.professors.length ? '<ul class="professor-cards">' : '<p>No professors found</p>', "\n              ").concat(results.professors.map(function (item) {
        ...
        }).join(''), "\n            ").concat(results.professors.length ? '</ul>' : '', "\n          </div>\n\n          <div class=\"one-third\">\n\n            <h2 class=\"search-overlay__section-title\">Campuses</h2>\n            ").concat(results.campuses.length ? '<ul class="link-list min-list">' : "<p>No campuses found. <a href=\"".concat(universityData.root_url, "/campuses\">View all campuses</a></p>"), "\n              ").concat(results.campuses.map(function (item) {
          return "<li><a href=\"".concat(item.permalink, "\">").concat(item.title, "</a></li>");
